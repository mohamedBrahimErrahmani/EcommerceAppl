...
final Map<String, WidgetBuilder> routes = {
  ...
  AdminPannelScreen.routeName: (context) => AdminPannelScreen(),
  AddProductScreen.routeName: (context) => AddProductScreen(),
  ListeProduitsScreen.routeName: (context) => ListeProduitsScreen(),
  ListProductsScreen.routeName: (context) => ListProductsScreen(),
  ListeCommandesScreen.routeName: (context) => ListeCommandesScreen(),
};
